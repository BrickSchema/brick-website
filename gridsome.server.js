...
const brickClasses = require('./static/ontology/1.1/classes.json')
const brickRelationships = require('./static/ontology/1.1/relationships.json')
const brickNamespaces = require('./static/ontology/1.1/namespaces.json')
...
module.exports = function (api, options) {
  api.loadSource(store => {
      ...
      */
      ...
      store.addMetaData('cacheCommitId', cacheCommitId)
