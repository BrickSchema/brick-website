<template>
  <Layout>
    ...
    <div class="hero container-inner mx-auto flex flex-col sm:flex-row justify-between py-16">
      <div class="w-1/6 ml-32 sm:mt-0">
        <g-image src="../../static/logo.png" alt="hero" class="h-auto mx-auto sm:mx-0"/>
      </div>
      ...
      <div class="contact-me pt-16">
        <div class="container-inner mx-auto text-xl pb-4 relative">
          ...
          <div class="text-lg sm:text-lg mb-16">
            Use the <a href="https://groups.google.com/d/forum/brickschema">developer forum</a> for asking questions and sharing comments related to the Brick schema.
